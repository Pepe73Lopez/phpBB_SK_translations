...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'				=> 'Ďakujeme za registráciu, váš účet bol vytvorený. Teraz sa môžete prihlásiť zadaním zvoleného užívateľského mena a hesla.',
	'ACCOUNT_COPPA'				=> 'Váš účet bol vytvorený, ale čaká na aktiváciu. Ďalšie pokyny boli odoslané na váš emailový účet, skontrolujte si emailovú schránku.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Váš účet bol aktualizovaný. Tento portál však pri zmene emailovej adresy vyžaduje reaktiváciu účtu. Aktivačný kľúč vám bol odoslaný na novú emailovú adresu, prosím skontrolujte si emailovú schránku.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	     => 'Váš účet bol aktualizovaný. Tento portál však pri zmene emailovej adresy vyžaduje reaktiváciu účtu administrátorom portálu. Administrátorom bola odoslaná žiadosť o reaktiváciu účtu, o výsledkoch budete čoskoro informovaný.',
	'ACCOUNT_INACTIVE'				=> 'Váš účet bol vytvorený. Tento portál však vyžaduje dodatočnú aktiváciu. Aktivačný kľúč vám bol odoslaný na zadanú emailovú adresu, prosím skontrolujte si emailovú schránku.',
	'ACCOUNT_INACTIVE_ADMIN'		     => 'Váš účet bol vytvorený. Tento portál však vyžaduje dodatočnú aktiváciu administrátormi portálu. Administrátorom bola odoslaná žiadosť o aktiváciu vášho účtu, o výsledkoch budete čoskoro informovaný.',
	'ACTIVATION_EMAIL_SENT'			=> 'Aktivačný email bol odoslaný na vašu emailovú adresu.',
	'ACTIVATION_EMAIL_SENT_ADMIN'	     => 'Aktivačný email bol odoslaný na emailovú adresu administrátorov.',
	'ADD'						=> 'Pridať',
	'ADD_BCC'						=> 'Pridať [Skryté]',
	...
	'ADMIN_EMAIL'					=> 'Prijímať emaily od administrátorov',
	...
	'CUSTOM_DATEFORMAT'			     => 'Vlastné…',

	'DEFAULT_ACTION'			     => 'Východisková akcia',
	'DEFAULT_ACTION_EXPLAIN'	          => 'Táto akcia je nastavená ako východisková, ak nebola vybraná iná.',
	'DEFAULT_ADD_SIG'			     => 'Pripojiť k príspevkom môj podpis',
	'DEFAULT_BBCODE'			     => 'Povoliť BBCode',
	'DEFAULT_NOTIFY'			     => 'Upozorniť ma na odpovede',
	'DEFAULT_SMILIES'			     => 'Povoliť emotikony',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	     => 'Zadaná emailová doména nemá platný MX záznam.',
	'DOWNLOADS'					=> 'Stiahnuté',
	...
	'EMAIL_BANNED_EMAIL'		=> 'Zadanú emailovú adresa nie je možné použiť.',
	'EMAIL_REMIND'				=> 'Musíte uviesť emailovú adresu, ktorá je zviazaná s vašim účtom. Najdete ju v sekcii "Moje nastavenia". Ak ste ju vo svojich nastaveniach nezmemnili je to tá, s ktorou ste sa zaregistrovali na tomto portále.',
	'EMAIL_TAKEN_EMAIL'			=> 'Emailová adresa sa už používa.',
	'EMPTY_DRAFT'				=> 'Musíte vložiť správu ak chcete odoslať zmeny.',
	'EMPTY_DRAFT_TITLE'			=> 'Musíte zadať názov konceptu.',
	'EXPORT_AS_XML'			=> 'do XML',
	'EXPORT_AS_CSV'			=> 'do CSV',
	'EXPORT_AS_CSV_EXCEL'		=> 'do CSV (Excel)',
	'EXPORT_AS_TXT'			=> 'do TXT',
	'EXPORT_AS_MSG'			=> 'do MSG',
	'EXPORT_FOLDER'			=> 'Exportovať ako zoznam',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Vložte emailovú adresu, ktorú ste použili pri registrácii na <a href="http://www.gravatar.com/">Gravatar</a>.',
	...
	'NO_EMAIL_USER'			=> 'Užívateľ/emailová adresa nenájdená.',
	'NO_FOES'					=> 'Nikto',
	'NO_FRIENDS'				=> 'Nikto',
	'NO_FRIENDS_OFFLINE'		=> 'Žiaden z priateľov nie je offline',
	'NO_FRIENDS_ONLINE'			=> 'Žiaden z priateľov nie je offline',
	...
	'SHOW_EMAIL'				=> 'Užívatelia mi môžu posielať emailové správy',
	...
	'UCP_PM'					=> 'Súkromné správy (PM)',
	'UCP_PM_COMPOSE'			=> 'Vytvoriť súkromnú správu (PM)',
	...
	'VIEW_NEXT_HISTORY'			=> 'Ďalšia PM z histórie',
	'VIEW_NEXT_PM'				=> 'Ďalšia PM',
	...
	'VIEW_PREVIOUS_HISTORY'		=> 'Predchádzajúca PM z histórie',
	'VIEW_PREVIOUS_PM'			=> 'Predchádzajúca PM',
	'VIEW_PROFILE'				=> 'Zobraziť profil',
	'VIEW_SIGS'				=> 'Zobrazovať podpisy',
	'VIEW_SMILIES'				=> 'Zobrazovať emotikony ako obrázky',
