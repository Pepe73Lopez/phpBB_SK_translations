...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'				=> 'Ďakujeme za registráciu, váš účet bol vytvorený. Teraz sa môžete prihlásiť zadaním zvoleného užívateľského mena a hesla. Na vami zadanú emailovú adresu bola zároveň odoslaná uvítacia správa, v budúcnosti bude akákoľvek komunikácia prostredníctovm emailu s vami vedená práve z adresy, ktorá je uvedená ako adresa odosielatel. Skontrolujte si prosím doručnú poštu vašej emailovj schránky. Pokiaľ spomenutý email nenájdete, je možné, že váš poštový server označil poštu ako spam, skontrolujte si preto prosím, priečinok SPAM.',
	...
	'ACTIVATION_EMAIL_SENT'			=> 'Aktivačný email bol odoslaný na vašu emailovú adresu. Pokiaľ spomenutý email nenájdete, je možné, že váš poštový server označil poštu ako spam, skontrolujte si preto prosím, priečinok SPAM.',
