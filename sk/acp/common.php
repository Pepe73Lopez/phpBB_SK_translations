...
$lang = array_merge($lang, array(
	...
	'ACP_ADMIN_LOGS'			=> 'Záznam činností administrátorov',
	'ACP_ADMIN_ROLES'			=> 'Sady oprávnení pre adminov',
	'ACP_ATTACHMENTS'			=> 'Prílohy',
	'ACP_ATTACHMENT_SETTINGS'	=> 'Nastavenia príloh',
	'ACP_AUTH_SETTINGS'			=> 'Overovanie identity',
	'ACP_AUTOMATION'			=> 'Automatické úlohy',
	'ACP_AVATAR_SETTINGS'		=> 'Nastavenia avatarov',

	'ACP_BACKUP'				=> 'Zálohovanie',
	'ACP_BAN'					=> 'Banning',
	'ACP_BAN_EMAILS'			=> 'Ban na emailové adresy',
	'ACP_BAN_IPS'				=> 'Ban na IP adresy',
	'ACP_BAN_USERNAMES'			=> 'Ban na užívateľské mená',
	'ACP_BBCODES'				=> 'BB kódy',
	'ACP_BOARD_CONFIGURATION'	=> 'Konfigurácia portálu',
	'ACP_BOARD_FEATURES'		=> 'Funkcie portálu',
	'ACP_BOARD_MANAGEMENT'		=> 'Správa portálu',
	'ACP_BOARD_SETTINGS'		=> 'Nastavenia portálu',
	'ACP_BOTS'				=> 'Správa vyhľadávacích robotov',
	...
	'ACP_INACTIVE_USERS'		=> 'Neaktivované účty',
	'ACP_INDEX'					=> 'ACP index',
	...
	'ACP_MANAGE_EXTENSIONS'		=> 'Správa prípon príloh',
	'ACP_MANAGE_FORUMS'			=> 'Správa Kategórií &amp; Fór',
	'ACP_MANAGE_RANKS'			=> 'Správa hodností',
	'ACP_MANAGE_REASONS'		=> 'Správa dôvodov sťažností/zamietnutí',
	'ACP_MANAGE_USERS'			=> 'Správa užívateľov',
	'ACP_MASS_EMAIL'			=> 'Hromadný email',
	'ACP_MESSAGES'				=> 'Messages',
	'ACP_MESSAGE_SETTINGS'		=> 'Nastavenia súkromných správ',
	'ACP_MODULE_MANAGEMENT'		=> 'Module management',
	'ACP_MOD_LOGS'				=> 'Záznam činností moderátorov',
	'ACP_MOD_ROLES'				=> 'Sady oprávnení pre moderátorov',

	'ACP_NO_ITEMS'				=> 'There are no items yet.',

	'ACP_ORPHAN_ATTACHMENTS'	=> 'Osirelé prílohy',

	'ACP_PERMISSIONS'			=> 'Permissions',
	'ACP_PERMISSION_MASKS'		=> 'Zobrazenie oprávnení',
	'ACP_PERMISSION_ROLES'		=> 'Prednastavené sady oprávnení',
	'ACP_PERMISSION_TRACE'		=> 'Permission trace',
	'ACP_PHP_INFO'				=> 'Informácie o prostredí PHP',
	'ACP_POST_SETTINGS'			=> 'Nastavenia písania príspevkov',
	'ACP_PRUNE_FORUMS'			=> 'Prečistiť fóra',
	'ACP_PRUNE_USERS'			=> 'Prečistiť užívateľov',
	'ACP_PRUNING'				=> 'Čistenie',
	...
	'ACP_FEED_SETTINGS'			=> 'Nastavenia odberu kanálov',

	'ACP_SEARCH'				=> 'Search configuration',
	'ACP_SEARCH_INDEX'			=> 'Search index',
	'ACP_SEARCH_SETTINGS'		=> 'Nastavenia vyhľadávania',

	'ACP_SECURITY_SETTINGS'		=> 'Bezpečnostné nastavenia',
	'ACP_SEND_STATISTICS'		=> 'Odoslať štatistické informácie',
	'ACP_SERVER_CONFIGURATION'	=> 'Konfigurácia serveru',
	'ACP_SERVER_SETTINGS'		=> 'Nastavenia serveru',
	'ACP_SIGNATURE_SETTINGS'	     => 'Nastavenia podpisu',
	...
	'ACP_UPDATE'					=> 'Updating',
	'ACP_USERS_FORUM_PERMISSIONS'	     => 'Oprávnenia užívateľa vo fórach',
	'ACP_USERS_LOGS'				=> 'Záznamy činností užívateľa',
	'ACP_USERS_PERMISSIONS'			=> 'Oprávnenia užívateľa',
	'ACP_USER_ATTACH'				=> 'Prílohy',
	'ACP_USER_AVATAR'				=> 'Avatar',
	'ACP_USER_FEEDBACK'				=> 'Spätná väzba od užívateľa',
	'ACP_USER_GROUPS'				=> 'Skupiny',
	'ACP_USER_MANAGEMENT'			=> 'Správa užívateľa',
	'ACP_USER_OVERVIEW'				=> 'Prehľad',
	'ACP_USER_PERM'					=> 'Oprávnenia',
	'ACP_USER_PREFS'				=> 'Predvoľby',
	'ACP_USER_PROFILE'				=> 'Profil',
	'ACP_USER_RANK'					=> 'Hodnosť',
	'ACP_USER_ROLES'				=> 'Sady oprávnení pre užívateľov',
	'ACP_USER_SECURITY'				=> 'User security',
	'ACP_USER_SIG'					=> 'Podpis',
	'ACP_USER_WARNINGS'				=> 'Výstrahy',

	'ACP_VC_SETTINGS'					=> 'Opatrenia proti spambotom',
	...
	'ADM_LOGOUT'			=> 'Odhlásiť sa z administrátorského panelu',
	'ADM_LOGGED_OUT'		=> 'Successfully logged out from Administration Control Panel',

	'BACK'					=> 'Back',

	'COLOUR_SWATCH'			=> 'Bezpečná paleta farieb',
	...
	'LOGIN_ADMIN'			=> 'Ak chcete vstúpiť do Administrátorského panelu, vaša identita musí byť overená.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Ak chcete vstúpiť do Administrátorského panelu, musí prebehnúť opätovné overenie identity. Prosím zadajte znovu svoje prihlasovacie údaje.',
	'LOGIN_ADMIN_SUCCESS'	=> 'Overenie identity prebehlo úspešne. Budete presmerovaný do Administrátorského panelu.',
...
$lang = array_merge($lang, array(
	...
	'PURGE_SESSIONS'		=> 'Obnoviť všetky relácie',
	'PURGE_SESSIONS_CONFIRM'	=> 'Ste si istý, že chcete obnoviť všetky relácie? To spôsobý odhlásenie všetkých momentálne prihlásených užívateľov.',
	'PURGE_SESSIONS_EXPLAIN'	=> 'Obnovenie všetkých relácií (pripojení). Toto spôsobí, že všetci momentálne pripojení užívatelia budú odhlásení, vymazaním tabuľky relácií (session).',
	'PURGE_SESSIONS_SUCCESS'	=> 'Relácie úspešne obnovené.',

	'RESET_DATE'					=> 'Obnoviť časovú pečiatku spustenia portálu<br />(bude nastavená na hodnotu momentu obnovenia)',
...
$lang = array_merge($lang, array(
	...
	'HIDE_STATISTICS'			=> 'Skryť detaily',
	'SEND_STATISTICS'			=> 'Odoslať štatistické informácie',
	'SHOW_STATISTICS'			=> 'Zobraziť detaily',
...
$lang = array_merge($lang, array(
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Obnovenie témy</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Zamietnutie témy “%1$s”, autor “%3$s”, dôvod </strong><br />» %2$s',
	'LOG_TOPIC_RESYNC'			=> '<strong>Resynchronised topic counters</strong><br />» %s',
	'LOG_TOPIC_TYPE_CHANGED'	     => '<strong>Zmena typu príspevku</strong><br />» %s',
	'LOG_UNLOCK'				=> '<strong>Odomknutie témy</strong><br />» %s',
	'LOG_UNLOCK_POST'			=> '<strong>Zamknutie príspevku</strong><br />» %s',
